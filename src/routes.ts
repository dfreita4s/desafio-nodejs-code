...
routes.delete('/member/:id', authMiddleware, new MemberController().remove);
...
routes.delete('/role/:id', authMiddleware, new RoleController().remove);
...
routes.delete('/department/:id', authMiddleware, new DepartmentController().remove);
